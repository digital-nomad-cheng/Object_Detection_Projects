"""
Generate positive, negative, positive size 12*12 images for PNet
"""
import os, sys
sys.path.append('.')
import cv2
...
#anno_file = './annotations/user_anno_val.txt'.format(mode)
...
f1 = open(os.path.join('annotations', 'pos_{}_{}.txt'.format(net_size, mode)), 'a')
f2 = open(os.path.join('annotations', 'neg_{}_{}.txt'.format(net_size, mode)), 'a')
f3 = open(os.path.join('annotations', 'part_{}_{}.txt'.format(net_size, mode)), 'a')
