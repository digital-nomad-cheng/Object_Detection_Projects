...
from retinaface.config import get_cfg
...
def setup_cfg(args):
    ...
    cfg.MODEL.RETINAFACE.SCORE_THRESH_TEST = args.confidence_threshold
    ...
    if args.input:
        ...
        for path in tqdm.tqdm(args.input, disable=not args.output):
            ...
            if args.output:
                ...
                if cv2.waitKey(0) == 27:
                    break  # esc to quit
        with open(os.path.join(args.output, "results.pkl"), 'wb') as w_obj:
            pickle.dump(result, w_obj)
    elif args.webcam:
