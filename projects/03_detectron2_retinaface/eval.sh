...
python evaluate_widerface/parse_predictions_to_widerface_val.py --res work_dirs/retinaface_R50_FPN/val/results.pkl --save work_dirs/retinaface_R53_FPN/widerface_val
